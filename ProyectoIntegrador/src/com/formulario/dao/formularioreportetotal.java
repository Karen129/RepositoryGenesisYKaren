 ...
 * @author Steven
 */
public class formularioreportetotal extends javax.swing.JFrame {

    conexion con= new conexion();
    Connection conex= con.Conectar();
    public formularioreportetotal() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formularioreportetotal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
