 ...
 * @author Steven
 */
public class formularioreporte extends javax.swing.JFrame {
    ...
    public formularioreporte() {
     ...
     public void Reporte(){
       ...
       modelo.addColumn("FECHA");
        ...
        try{
            Statement rt = conex.createStatement();
    ...
    private void initComponents() {
        ...
        getContentPane().add(bnImprimir, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 70, -1, -1));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-80, -50, 180, 490));
        getContentPane().add(dcfecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 60, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formularioreporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
